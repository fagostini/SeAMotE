...
# 		awk 'BEGIN{printf "<tbody>\n"}{printf "\t<tr>\n\t\t<td>%d</td>\n\t\t<td>%s</td>\n\t\t<td>%s</td>\n\t\t<td><img src=\"logos/%s_logo.png\" width=\"%d\" height=\"50\" style=\"solid white; display:block; margin-top:-1px; margin-left:1px; margin-right:-6px; margin-bottom:-1px;\"/></td>\n\t\t<td>%d</td>\n\t\t<td>%d</td>\n\t\t<td>%d</td>\n\t\t<td>%.3E</td>\n\t</tr>\n", NR, $1, $2, $1, length($1)*30, $5*100, $6*100, $7*100, $8 }END{printf "</tbody>\n"}' ./outputs/best_motifs.txt > ./outputs/table.html
 		awk 'BEGIN{printf "<tbody>\n"}{printf "\t<tr>\n\t\t<td>%d</td>\n\t\t<td>%s</td>\n\t\t<td class=\"regex\">%s</td>\n\t\t<td class=\"logo\"><a href=\"logos/%s_logo.png\"><img src=\"logos/%s_logo.png\" width=\"%d\" height=\"50\" /></a></td>\n\t\t<td class=\"pwm\"><a href=\"logos/%s_pwm.txt\"><img src=\"download.gif\" width=\"50\" height=\"50\" style=\"display:block;\"/></a></td>\n\t\t<td>%d</td>\n\t\t<td>%d</td>\n\t\t<td>%d</td>\n\t\t<td>%.3E</td>\n\t</tr>\n", NR, $1, $2, $1, $1, length($1)*25, $1, $5*100, $6*100, $7*100, $8 }END{printf "</tbody>\n"}' ./outputs/best_motifs.txt > ./outputs/table.html
